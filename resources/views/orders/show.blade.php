...
@section('content')
    ...
    <section class="panel form-panel lifecycle-panel">
        ...
        @if($order->status === 'created' && auth()->user()->role !== 'auditor')
        ...
        @endif
        @if($order->canBeCancelled() && $order->paid_at && auth()->user()->role !== 'auditor')
